        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    <div> <a href="#" onClick={(e) => handlePlantsClick(e)} style={{...styleA, fontWeight: 'bold'}}>Plants</a></div>
                    <div style={{ textAlign: 'center', position: 'relative', bottom: 11 }}> 
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <span style={{ position: 'relative', top: 42 }}>{totalQuantity()}</span>
                            <h1 className='cart'>
